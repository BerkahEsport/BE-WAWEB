...
let handler = async (m, { args, usedPrefix, command }) => {
    ...
    for (let sticker of stik.result) {
        ...
        await m.reply( new MessageMedia((await FileType.fromBuffer(buff)).mime, buff.toString("base64")), false, { sendMediaAsSticker: true, stickerName: `ʙᴇʀᴋᴀʜᴇꜱᴘᴏʀᴛ.ɪᴅ ᴏꜰᴄ · @_moexti_`, stickerAuthor: `@_moexti_`, stickerCategories: ['😅'] } )
    }
}
